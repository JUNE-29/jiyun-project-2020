# 41_1 - 정지윤의 책 기록형 애플리케이션 프로젝트 만들기
...
- june.project.utilApplicationContext 클래스 변경
...
### 작업8) 객체를 생성할 수 있는 concrete class 만 추출한다.(ApplicationContext08)
...
### 작업16) 생성자 파라미터 값을 준비하는 메서드를 추가한다.(ApplicationContext16)
